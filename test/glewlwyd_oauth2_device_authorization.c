...
#define PLUGIN_NAME "oauth2_device"
#define PLUGIN_DISPLAY_NAME "oauth2 with device authorization"
...
START_TEST(test_oauth2_device_authorization_add_module_ok)
{
...
START_TEST(test_oauth2_device_authorization_add_client_confidential_ok)
{
...
START_TEST(test_oauth2_device_authorization_add_client_public_ok)
{
...
START_TEST(test_oauth2_device_authorization_add_client_unauthorized)
{
  json_t * j_parameters = json_pack("{sssssos[s]so}",
                                "client_id", CLIENT_ID,
                                "client_name", CLIENT_NAME,
...
START_TEST(test_oauth2_device_authorization_delete_module)
{
...
START_TEST(test_oauth2_device_authorization_delete_client)
{
  ck_assert_int_eq(run_simple_test(&admin_req, "DELETE", SERVER_URI "/client/" CLIENT_ID, NULL, NULL, NULL, NULL, 200, NULL, NULL, NULL), 1);
}
END_TEST

START_TEST(test_oauth2_device_authorization_client_cred_post_valid)
{
  ...
  ck_assert_str_eq(json_string_value(json_object_get(j_resp, "verification_uri")), "http://localhost:4593/api/oauth2_device/device");
...
START_TEST(test_oauth2_device_authorization_client_cred_header_valid)
{
  struct _u_request req;
  struct _u_response resp;
  json_t * j_resp;
...
START_TEST(test_oauth2_device_authorization_client_cred_header_invalid)
{
  struct _u_request req;
  struct _u_response resp;
...
START_TEST(test_oauth2_device_authorization_client_cred_header_no_post_valid)
{
  struct _u_request req;
  struct _u_response resp;
  json_t * j_resp;
...
START_TEST(test_oauth2_device_authorization_client_pub_post_valid)
{
  struct _u_request req;
  struct _u_response resp;
  json_t * j_resp;
...
START_TEST(test_oauth2_device_authorization_client_pub_post_invalid)
{
  struct _u_request req;
  struct _u_response resp;
...
START_TEST(test_oauth2_device_authorization_user_code_redirect_login_valid)
{
  struct _u_request req;
  struct _u_response resp;
  json_t * j_resp;
...
START_TEST(test_oauth2_device_authorization_user_code_input_invalid)
{
  struct _u_request req;
  struct _u_response resp;
  json_t * j_resp;
...
START_TEST(test_oauth2_device_authorization_user_code_input_redirect_login_valid)
{
  struct _u_request req;
  struct _u_response resp;
  json_t * j_resp;
...
START_TEST(test_oauth2_device_authorization_user_code_input_complete_valid)
{
  struct _u_request req;
  struct _u_response resp;
...
START_TEST(test_oauth2_device_authorization_device_verification_valid)
{
  struct _u_request req;
  struct _u_response resp;
  json_t * j_resp, * j_grant;
...
START_TEST(test_oauth2_device_authorization_device_verification_code_replay_invalid)
{
  struct _u_request req;
  struct _u_response resp;
  json_t * j_resp, * j_grant;
...
START_TEST(test_oauth2_device_authorization_device_verification_auth_pending)
{
  struct _u_request req;
  struct _u_response resp;
  json_t * j_resp;
...
START_TEST(test_oauth2_device_authorization_device_verification_auth_slow_down)
{
  struct _u_request req;
  struct _u_response resp;
  json_t * j_resp;
...
START_TEST(test_oauth2_device_authorization_device_verification_device_code_invalid)
{
  struct _u_request req;
  struct _u_response resp;
  json_t * j_resp, * j_grant;
...
START_TEST(test_oauth2_device_authorization_device_verification_client_invalid)
{
  struct _u_request req;
  struct _u_response resp;
  json_t * j_resp, * j_grant;
...
START_TEST(test_oauth2_device_authorization_device_verification_client_secret_invalid)
{
  struct _u_request req;
  struct _u_response resp;
  json_t * j_resp, * j_grant;
...
static Suite *glewlwyd_suite(void)
{
  ...
  s = suite_create("Glewlwyd oauth2 device authorization");
  tc_core = tcase_create("test_oauth2_device_authorization");
  tcase_add_test(tc_core, test_oauth2_device_authorization_add_module_ok);
  tcase_add_test(tc_core, test_oauth2_device_authorization_add_client_public_ok);
  tcase_add_test(tc_core, test_oauth2_device_authorization_client_pub_post_valid);
  tcase_add_test(tc_core, test_oauth2_device_authorization_delete_client);
  tcase_add_test(tc_core, test_oauth2_device_authorization_add_client_unauthorized);
  tcase_add_test(tc_core, test_oauth2_device_authorization_client_pub_post_invalid);
  tcase_add_test(tc_core, test_oauth2_device_authorization_delete_client);
  tcase_add_test(tc_core, test_oauth2_device_authorization_add_client_confidential_ok);
  tcase_add_test(tc_core, test_oauth2_device_authorization_client_cred_post_valid);
  tcase_add_test(tc_core, test_oauth2_device_authorization_client_cred_header_valid);
  tcase_add_test(tc_core, test_oauth2_device_authorization_client_cred_header_no_post_valid);
  tcase_add_test(tc_core, test_oauth2_device_authorization_client_cred_header_invalid);
  tcase_add_test(tc_core, test_oauth2_device_authorization_user_code_redirect_login_valid);
  tcase_add_test(tc_core, test_oauth2_device_authorization_user_code_input_invalid);
  tcase_add_test(tc_core, test_oauth2_device_authorization_user_code_input_redirect_login_valid);
  tcase_add_test(tc_core, test_oauth2_device_authorization_user_code_input_complete_valid);
  tcase_add_test(tc_core, test_oauth2_device_authorization_device_verification_valid);
  tcase_add_test(tc_core, test_oauth2_device_authorization_device_verification_code_replay_invalid);
  tcase_add_test(tc_core, test_oauth2_device_authorization_device_verification_auth_pending);
  tcase_add_test(tc_core, test_oauth2_device_authorization_device_verification_auth_slow_down);
  tcase_add_test(tc_core, test_oauth2_device_authorization_device_verification_device_code_invalid);
  tcase_add_test(tc_core, test_oauth2_device_authorization_device_verification_client_invalid);
  tcase_add_test(tc_core, test_oauth2_device_authorization_device_verification_client_secret_invalid);
  tcase_add_test(tc_core, test_oauth2_device_authorization_delete_client);
  tcase_add_test(tc_core, test_oauth2_device_authorization_delete_module);
