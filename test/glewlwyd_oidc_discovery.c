...
{
  json_t * j_param = json_pack("{sssssss{sssssssssssisisisosososososososososssss[{ssssso}{ssssso}]sssss{ssss}s[ssss]s[s]sosososos[s]sososssososi}}",
                                "module", "oidc",
                                "name", PLUGIN_NAME,
