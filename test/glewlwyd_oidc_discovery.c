...
{
  json_t * j_result = json_loads("{\"issuer\":\"https://glewlwyd.tld\",\"authorization_endpoint\":\"http://localhost:4593/api/oidc/auth\",\"token_endpoint\":\"http://localhost:4593/api/oidc/token\",\"userinfo_endpoint\":\"http://localhost:4593/api/oidc/userinfo\",\"jwks_uri\":\"http://localhost:4593/api/oidc/jwks\",\"token_endpoint_auth_methods_supported\":[\"client_secret_basic\"],\"token_endpoint_auth_signing_alg_values_supported\":[\"HS256\"],\"scopes_supported\":[\"openid\"],\"response_types_supported\":[\"code\",\"id_token\",\"token id_token\",\"code id_token\",\"code token id_token\",\"password\",\"token\",\"client_credentials\",\"refresh_token\"],\"response_modes_supported\":[\"query\",\"fragment\"],\"grant_types_supported\":[\"authorization_code\",\"implicit\"],\"display_values_supported\":[\"page\",\"touch\",\"wap\"],\"claim_types_supported\":[\"normal\"],\"claims_supported\":[],\"service_documentation\":\"https://github.com/babelouest/glewlwyd/tree/master/docs\",\"ui_locales_supported\":[\"en\",\"fr\"],\"claims_parameter_supported\":true,\"request_parameter_supported\":false,\"request_uri_parameter_supported\":false,\"require_request_uri_registration\":false,\"op_policy_uri\":\"https://www.un.org/fr/universal-declaration-human-rights/\",\"op_tos_uri\":\"https://www.un.org/fr/universal-declaration-human-rights/\"}", JSON_DECODE_ANY, NULL);
...
{
  json_t * j_param = json_pack("{sssssss{sssssssssssisisisosososososos[{ssss}{ssss}]}}",
                                "module",
                                "oidc",
                                "name",
                                PLUGIN_NAME,
...
START_TEST(test_glwd_oidc_discovery_new_plugin_test)
{
  json_t * j_result = json_loads("{\"issuer\":\"https://glewlwyd.tld\",\"authorization_endpoint\":\"http://localhost:4593/api/oidc_claims/auth\",\"token_endpoint\":\"http://localhost:4593/api/oidc_claims/token\",\"userinfo_endpoint\":\"http://localhost:4593/api/oidc_claims/userinfo\",\"jwks_uri\":\"http://localhost:4593/api/oidc_claims/jwks\",\"token_endpoint_auth_methods_supported\":[\"client_secret_basic\"],\"token_endpoint_auth_signing_alg_values_supported\":[\"RS256\"],\"scopes_supported\":[\"openid\"],\"response_types_supported\":[\"code\",\"id_token\",\"token id_token\",\"code id_token\",\"code token id_token\",\"refresh_token\"],\"response_modes_supported\":[\"query\",\"fragment\"],\"grant_types_supported\":[\"authorization_code\",\"implicit\"],\"display_values_supported\":[\"page\",\"touch\",\"wap\"],\"claim_types_supported\":[\"normal\"],\"claims_supported\":[\"claim1\",\"claim2\"],\"service_documentation\":\"https://github.com/babelouest/glewlwyd/tree/master/docs\",\"ui_locales_supported\":[\"en\",\"fr\"],\"claims_parameter_supported\":true,\"request_parameter_supported\":false,\"request_uri_parameter_supported\":false,\"require_request_uri_registration\":false,\"op_policy_uri\":\"https://www.un.org/fr/universal-declaration-human-rights/\",\"op_tos_uri\":\"https://www.un.org/fr/universal-declaration-human-rights/\"}", JSON_DECODE_ANY, NULL),
  * j_key = json_loads("{\"kty\":\"RSA\",\"use\":\"sig\",\"key_ops\":\"sig\",\"alg\":\"RS256\",\"kid\":\"https://glewlwyd.tld\",\"x5c\":[\"-----BEGIN PUBLIC KEY-----\\nBwIDAQAB\n-----END PUBLIC KEY-----\"]}", JSON_DECODE_ANY, NULL);
...
START_TEST(test_glwd_oidc_discovery_delete_plugin)
{
...
static Suite *glewlwyd_suite(void)
{
  ...
  tc_core = tcase_create("test_glwd_oidc_irl");
  tcase_add_test(tc_core, test_glwd_oidc_discovery_default_test);
  tcase_add_test(tc_core, test_glwd_oidc_discovery_add_plugin);
  tcase_add_test(tc_core, test_glwd_oidc_discovery_new_plugin_test);
  tcase_add_test(tc_core, test_glwd_oidc_discovery_delete_plugin);
