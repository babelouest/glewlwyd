...
{
  json_t * j_param = json_pack("{sssssss{sssssssssssisisisosososososososososssss[{ssssso}{ssssso}]sssss{ssss}s[ssss]s[s]sosososos[s]sosossso}}",
                                "module",
                                "oidc",
                                "name",
                                PLUGIN_NAME,
                                ...
                                "parameters",
                                  ...
                                  "client-cert-source",
                                  "TLS",
                                  "client-cert-use-endpoint-aliases",
                                  json_true());
