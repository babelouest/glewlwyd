...
{
  json_t * j_param = json_pack("{sssssss{sssssssssssisisisososososososososssss[{ssssso}{ssssso}]sssss{ssss}s[ssss]s[s]sosososos[s]soso}}",
                                "module",
                                "oidc",
                                "name",
                                PLUGIN_NAME,
