...
#define RESPONSE_TYPE "none"

struct _u_request user_req;
char * code;

START_TEST(test_oidc_implicit_none_redirect_login)
{
...
START_TEST(test_oidc_implicit_none_redirect_login_post)
{
...
START_TEST(test_oidc_implicit_none_valid)
{
...
START_TEST(test_oidc_implicit_none_valid_post)
{
  struct _u_response resp;
...
START_TEST(test_oidc_implicit_none_client_invalid)
{
...
START_TEST(test_oidc_implicit_none_redirect_uri_invalid)
{
...
START_TEST(test_oidc_implicit_none_scope_invalid)
{
...
START_TEST(test_oidc_implicit_none_empty)
{
...
START_TEST(test_oidc_implicit_none_scope_grant_partial)
{
...
START_TEST(test_oidc_implicit_none_scope_grant_none)
{
  struct _u_request auth_req, code_req;
  struct _u_response auth_resp, code_resp;
  json_t * j_body;
  ...
  ck_assert_int_eq(ulfius_send_http_request(&code_req, &code_resp), U_OK);
  ck_assert_int_eq(code_resp.status, 302);
  ck_assert_ptr_eq(o_strstr(u_map_get(code_resp.map_header, "Location"), "invalid_scope"), NULL);
...
START_TEST(test_oidc_implicit_none_scope_grant_all_authorize_partial)
{
  struct _u_request auth_req, code_req;
  struct _u_response auth_resp, code_resp;
  json_t * j_body;
...
START_TEST(test_oidc_implicit_none_retry_with_max_use)
{
  struct _u_request auth_req, code_req;
  struct _u_response auth_resp, code_resp;
  json_t * j_body;
...
static Suite *glewlwyd_suite(void)
{
  ...
  s = suite_create("Glewlwyd oidc implicit none");
  tc_core = tcase_create("test_oidc_implicit_none");
  tcase_add_test(tc_core, test_oidc_implicit_none_redirect_login);
  tcase_add_test(tc_core, test_oidc_implicit_none_redirect_login_post);
  tcase_add_test(tc_core, test_oidc_implicit_none_valid);
  tcase_add_test(tc_core, test_oidc_implicit_none_valid_post);
  tcase_add_test(tc_core, test_oidc_implicit_none_client_invalid);
  tcase_add_test(tc_core, test_oidc_implicit_none_redirect_uri_invalid);
  tcase_add_test(tc_core, test_oidc_implicit_none_scope_invalid);
  ...
  tcase_add_test(tc_core, test_oidc_implicit_none_retry_with_max_use);
