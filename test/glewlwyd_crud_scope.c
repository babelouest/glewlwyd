...
START_TEST(test_glwd_crud_scope_list_pattern)
{
  ...
  ck_assert_str_eq(json_string_value(json_object_get(json_array_get(j_result, 0), "name")), "openid");
...
START_TEST(test_glwd_crud_scope_list_limit)
{
  ...
  ck_assert_str_eq(json_string_value(json_object_get(json_array_get(j_result, 1), "name")), "openid");
  ck_assert_str_eq(json_string_value(json_object_get(json_array_get(j_result, 2), "name")), "scope1");
  ck_assert_str_eq(json_string_value(json_object_get(json_array_get(j_result, 3), "name")), "scope2");
  ck_assert_str_eq(json_string_value(json_object_get(json_array_get(j_result, 4), "name")), "scope3");
  o_free(admin_req.http_url);
  o_free(admin_req.http_verb);
  admin_req.http_url = NULL;
  admin_req.http_verb = NULL;
