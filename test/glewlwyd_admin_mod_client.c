...
START_TEST(test_glwd_admin_get_mod_client_get_list)
{
...
START_TEST(test_glwd_admin_get_mod_client_add_error_json)
{
  char * url = msprintf("%s/mod/client/", SERVER_URI);
...
START_TEST(test_glwd_admin_get_mod_client_add_error_param)
{
  char * url = msprintf("%s/mod/client/", SERVER_URI);
...
START_TEST(test_glwd_admin_get_mod_client_add_OK)
{
  char * url = msprintf("%s/mod/client/", SERVER_URI);
  ...
  url = msprintf("%s/mod/client/%s", SERVER_URI, MODULE_NAME);
...
START_TEST(test_glwd_admin_get_mod_client_get)
{
  char * url = msprintf("%s/mod/client/%s", SERVER_URI, MODULE_NAME), * url_404 = msprintf("%s/mod/client/error", SERVER_URI);
  json_t * j_parameters = json_pack("{sssssssisos{ss}}", "module", MODULE_MODULE, "name", MODULE_NAME, "display_name", MODULE_DISPLAY_NAME, "order_rank", 0, "readonly", json_false(), "parameters", "mock-value", MODULE_NAME);
...
START_TEST(test_glwd_admin_get_mod_client_set_error_param)
{
  char * url = msprintf("%s/mod/client/%s", SERVER_URI, MODULE_NAME);
  json_t * j_parameters = json_pack("{ss}", "error", "error");
...
START_TEST(test_glwd_admin_get_mod_client_set_OK)
{
  char * url = msprintf("%s/mod/client/%s", SERVER_URI, MODULE_NAME);
...
START_TEST(test_glwd_admin_get_mod_client_action)
{
...
START_TEST(test_glwd_admin_get_mod_client_delete_error)
{
  char * url = msprintf("%s/mod/client/error", SERVER_URI);
...
START_TEST(test_glwd_admin_get_mod_client_delete_OK)
{
  char * url = msprintf("%s/mod/client/%s", SERVER_URI, MODULE_NAME);
...
static Suite *glewlwyd_suite(void)
{
  ...
  s = suite_create("Glewlwyd admin module client");
  tc_core = tcase_create("test_glwd_admin_mod_client");
  tcase_add_test(tc_core, test_glwd_admin_get_mod_client_get_list);
  ...
  tcase_add_test(tc_core, test_glwd_admin_get_mod_client_get);
  tcase_add_test(tc_core, test_glwd_admin_get_mod_client_set_error_param);
  tcase_add_test(tc_core, test_glwd_admin_get_mod_client_set_OK);
