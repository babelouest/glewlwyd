...
START_TEST(test_oauth2_auth_code_ok_redirect_login)
{
...
START_TEST(test_oauth2_auth_code_scope_invalid)
{
...
START_TEST(test_oauth2_auth_code_ok_redirect_cb_with_code)
{
...
static Suite *glewlwyd_suite(void)
{
  ...
  tcase_add_test(tc_core, test_oauth2_auth_code_uri_invalid);
  tcase_add_test(tc_core, test_oauth2_auth_code_scope_invalid);
  tcase_add_test(tc_core, test_oauth2_auth_code_scope_empty);
  tcase_add_test(tc_core, test_oauth2_auth_code_ok_redirect_cb_with_code);
