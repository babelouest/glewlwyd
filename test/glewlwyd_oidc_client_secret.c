...
START_TEST(test_oidc_client_secret_resource_owner_pwd_cred_valid_secret)
{
...
START_TEST(test_oidc_client_secret_resource_owner_pwd_cred_valid_password)
{
  char * url = msprintf("%s/oidc/token/", SERVER_URI);
  struct _u_map body;
  u_map_init(&body);
...
static Suite *glewlwyd_suite(void)
{
  ...
  s = suite_create("Glewlwyd oidc client secret");
  tc_core = tcase_create("test_oidc_client_secret");
  tcase_add_test(tc_core, test_oidc_client_secret_resource_owner_pwd_cred_valid_password);
  tcase_add_test(tc_core, test_oidc_client_secret_client_set_ok);
  tcase_add_test(tc_core, test_oidc_client_secret_resource_owner_pwd_cred_valid_secret);
