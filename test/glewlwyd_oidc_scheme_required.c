...
#define RESPONSE_TYPE_ID_TOKEN "id_token"
...
START_TEST(test_oidc_scheme_required_scope_set)
{
...
START_TEST(test_oidc_scheme_required_auth_flow)
{
  ...
  ck_assert_int_eq(run_simple_test(&auth_req, "GET", SERVER_URI "/oidc/auth?response_type=" RESPONSE_TYPE_TOKEN " " RESPONSE_TYPE_ID_TOKEN "&g_continue&client_id=" CLIENT "&redirect_uri=" REDIRECT_URI "&state=xyzabcd&nonce=abcdxyz&scope=" SCOPE " openid&g_continue", NULL, NULL, NULL, NULL, 302, NULL, NULL, "login.html"), 1);
  ...
  ck_assert_int_eq(run_simple_test(&auth_req, "GET", SERVER_URI "/oidc/auth?response_type=" RESPONSE_TYPE_TOKEN " " RESPONSE_TYPE_ID_TOKEN "&g_continue&client_id=" CLIENT "&redirect_uri=" REDIRECT_URI "&state=xyzabcd&nonce=abcdxyz&scope=" SCOPE " openid&g_continue", NULL, NULL, NULL, NULL, 302, NULL, NULL, "id_token="), 1);

  ck_assert_int_eq(run_simple_test(&auth_req, "GET", SERVER_URI "/oidc/auth?response_type=" RESPONSE_TYPE_TOKEN " " RESPONSE_TYPE_ID_TOKEN "&g_continue&client_id=" CLIENT "&redirect_uri=" REDIRECT_URI "&state=xyzabcd&nonce=abcdxyz&scope=" SCOPE " openid&g_continue", NULL, NULL, NULL, NULL, 302, NULL, NULL, "access_token="), 1);
...
static Suite *glewlwyd_suite(void)
{
  ...
  s = suite_create("Glewlwyd oidc scheme required");
  tc_core = tcase_create("test_oidc_scheme_required");
  tcase_add_test(tc_core, test_oidc_scheme_required_scope_set);
  tcase_add_test(tc_core, test_oidc_scheme_required_auth_flow);
  tcase_add_test(tc_core, test_oidc_scheme_required_scope_delete);
