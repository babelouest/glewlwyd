...
START_TEST(test_oauth2_refresh_manage_session_endpoints_noauth)
{
...
START_TEST(test_oauth2_refresh_manage_session_list)
{
...
START_TEST(test_oauth2_refresh_manage_session_delete_not_found)
{
  struct _u_response resp;
...
START_TEST(test_oauth2_refresh_manage_session_delete_ok)
{
  char * url = SERVER_URI "/glwd/token/", * token_hash, * token_hash_encoded;
  struct _u_map body;
  struct _u_response resp;
  int res;
  json_t * j_body;
...
static Suite *glewlwyd_suite(void)
{
  ...
  s = suite_create("Glewlwyd oauth2 refresh manage session");
  tc_core = tcase_create("test_oauth2_refresh_manage_session");
  tcase_add_test(tc_core, test_oauth2_refresh_manage_session_endpoints_noauth);
  tcase_add_test(tc_core, test_oauth2_refresh_manage_session_list);
  tcase_add_test(tc_core, test_oauth2_refresh_manage_session_delete_not_found);
  tcase_add_test(tc_core, test_oauth2_refresh_manage_session_delete_ok);
