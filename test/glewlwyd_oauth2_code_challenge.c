...
START_TEST(test_oauth2_code_code_challenge_add_plugin_with_plain)
{
...
START_TEST(test_oauth2_code_code_challenge_add_plugin_without_plain)
{
  json_t * j_parameters = json_pack("{sssssssos{sssssssisisisososososososo}}",
                                "module", PLUGIN_MODULE,
                                "name", PLUGIN_NAME,
...
START_TEST(test_oauth2_code_code_challenge_remove_plugin)
{
...
START_TEST(test_oauth2_code_code_challenge_invalid_code_challenge_method)
{
...
START_TEST(test_oauth2_code_code_challenge_plain_invalid_code_challenge_method)
{
...
START_TEST(test_oauth2_code_code_challenge_plain_invalid_length)
{
...
START_TEST(test_oauth2_code_code_challenge_plain_invalid_charset)
{
...
START_TEST(test_oauth2_code_code_challenge_plain_verifier_ok)
{
  struct _u_response resp;
  char * code = NULL;
  struct _u_map body;
...
START_TEST(test_oauth2_code_code_challenge_s256_invalid_length)
{
  struct _u_response resp;
  char * code = NULL;
  struct _u_map body;
...
START_TEST(test_oauth2_code_code_challenge_s256_invalid_charset)
{
  struct _u_response resp;
  char * code = NULL;
  struct _u_map body;
...
START_TEST(test_oauth2_code_code_challenge_s256_verifier_invalid_value)
{
  struct _u_response resp;
  char * code = NULL;
  struct _u_map body;
...
static Suite *glewlwyd_suite(void)
{
  ...
  s = suite_create("Glewlwyd oauth2 code_challenge");
  tc_core = tcase_create("test_oauth2_code_challenge");
  tcase_add_test(tc_core, test_oauth2_code_code_challenge_add_plugin_with_plain);
