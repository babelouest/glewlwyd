...
#define USER_SCHEME "mock_scheme_42"
...
START_TEST(test_glwd_mail_on_scheme_register_add_users)
{
  json_t * j_body;
...
START_TEST(test_glwd_mail_on_scheme_register_remove_users)
{
  json_t * j_body = json_pack("{sssssss{so}}", "username", USER1, "scheme_type", "mock", "scheme_name", USER_SCHEME, "value", "register", json_false());
  ...
  j_body = json_pack("{sssssss{so}}", "username", USER2, "scheme_type", "mock", "scheme_name", USER_SCHEME, "value", "register", json_false());
  ck_assert_int_eq(run_simple_test(&admin_req, "POST", SERVER_URI "/delegate/" USER2 "/profile/scheme/register/", NULL, NULL, j_body, NULL, 200, NULL, NULL, NULL), 1);
  json_decref(j_body);

  j_body = json_pack("{sssssss{so}}", "username", USER3, "scheme_type", "mock", "scheme_name", USER_SCHEME, "value", "register", json_false());
  ck_assert_int_eq(run_simple_test(&admin_req, "POST", SERVER_URI "/delegate/" USER3 "/profile/scheme/register/", NULL, NULL, j_body, NULL, 200, NULL, NULL, NULL), 1);
  json_decref(j_body);
...
START_TEST(test_glwd_mail_on_scheme_register_delete_misc_config)
{
  ck_assert_int_eq(run_simple_test(&admin_req, "DELETE", SERVER_URI "/misc/" CONFIG_NAME, NULL, NULL, NULL, NULL, 200, NULL, NULL, NULL), 1);
}
END_TEST

START_TEST(test_glwd_mail_on_scheme_register_email_username_ok)
{
  ...
  j_body = json_pack("{sssssss{so}}", "username", USER1, "scheme_type", "mock", "scheme_name", USER_SCHEME, "value", "register", json_false());
...
START_TEST(test_glwd_mail_on_scheme_register_no_email_ok)
{
  struct smtp_manager manager;
  pthread_t thread;
  struct _u_request req;
...
START_TEST(test_glwd_mail_on_scheme_register_email_username_lang)
{
  struct smtp_manager manager;
  pthread_t thread;
  struct _u_request req;
...
static Suite *glewlwyd_suite(void)
{
  ...
  tc_core = tcase_create("test_glwd_mail_on_scheme_register");
  tcase_add_test(tc_core, test_glwd_mail_on_scheme_register_add_users);
  tcase_add_test(tc_core, test_glwd_mail_on_scheme_register_email_username_ok);
  tcase_add_test(tc_core, test_glwd_mail_on_scheme_register_no_email_ok);
  tcase_add_test(tc_core, test_glwd_mail_on_scheme_register_email_username_lang);
  tcase_add_test(tc_core, test_glwd_mail_on_scheme_register_delete_misc_config);
  tcase_add_test(tc_core, test_glwd_mail_on_scheme_register_remove_users);
