...
START_TEST(test_oidc_implicit_id_token_redirect_login)
{
...
START_TEST(test_oidc_implicit_id_token_redirect_login_post)
{
...
START_TEST(test_oidc_implicit_id_token_valid)
{
...
START_TEST(test_oidc_implicit_id_token_valid_post)
{
  struct _u_response resp;
...
START_TEST(test_oidc_implicit_id_token_client_invalid)
{
...
START_TEST(test_oidc_implicit_id_token_redirect_uri_invalid)
{
...
START_TEST(test_oidc_implicit_id_token_scope_invalid)
{
...
START_TEST(test_oidc_implicit_id_token_nonce_invalid)
{
...
START_TEST(test_oidc_implicit_id_token_empty)
{
...
START_TEST(test_oidc_implicit_id_token_scope_grant_partial)
{
...
START_TEST(test_oidc_implicit_id_token_scope_grant_none)
{
  struct _u_request auth_req, code_req;
  struct _u_response auth_resp, code_resp;
  json_t * j_body;
...
START_TEST(test_oidc_implicit_id_token_scope_grant_all_authorize_partial)
{
  struct _u_request auth_req, code_req;
  struct _u_response auth_resp, code_resp;
  json_t * j_body;
...
START_TEST(test_oidc_implicit_id_token_retry_with_max_use)
{
  struct _u_request auth_req, code_req;
  struct _u_response auth_resp, code_resp;
  json_t * j_body;
...
static Suite *glewlwyd_suite(void)
{
  ...
  tcase_add_test(tc_core, test_oidc_implicit_id_token_valid_post);
  tcase_add_test(tc_core, test_oidc_implicit_id_token_client_invalid);
  tcase_add_test(tc_core, test_oidc_implicit_id_token_redirect_uri_invalid);
  tcase_add_test(tc_core, test_oidc_implicit_id_token_scope_invalid);
  tcase_add_test(tc_core, test_oidc_implicit_id_token_nonce_invalid);
  tcase_add_test(tc_core, test_oidc_implicit_id_token_empty);
  tcase_add_test(tc_core, test_oidc_implicit_id_token_scope_grant_partial);
  tcase_add_test(tc_core, test_oidc_implicit_id_token_scope_grant_none);
  tcase_add_test(tc_core, test_oidc_implicit_id_token_scope_grant_all_authorize_partial);
