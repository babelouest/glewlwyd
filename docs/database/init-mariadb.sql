...
INSERT INTO `g_plugin` (`gp_module`, `gp_parameters`) VALUES ('oauth2-glewlwyd', '{"id":"oauth2-glewlwyd-1","url":"glwd","jwt-type":"sha","jwt-key-size":"256","key":"secret","access-token-duration":3600,"refresh-token-duration":1209600,"scope":[{"name":"g_profile","rolling-refresh":true}]}');
