...
{
  char * url = msprintf("%s/auth?response_type=invalid&client_id=client1_id&redirect_uri=../static/index.html&state=xyzabcd&scope=scope1 scope2", SERVER_URI);
...
{
  char * url = msprintf("%s/auth?response_type=code&client_id=client1_id&redirect_uri=../static/index.html&state=xyzabcd&scope=scope1 scope2", SERVER_URI);
...
{
  char * url = msprintf("%s/auth?response_type=code&client_id=client1_id&redirect_uri=../static/index.html?param=client1_cb1&state=xyz&scope=scope1 scope2", SERVER_URI);
...
{
  char * url = msprintf("%s/auth?response_type=code&client_id=client_error&redirect_uri=../static/index.html?param=client1_cb1&state=xyz&scope=scope1 scope2", SERVER_URI);
...
{
  char * url = msprintf("%s/auth?response_type=code&client_id=client_error&redirect_uri=../static/index.html?param=invalid&state=xyz&scope=scope1 scope2", SERVER_URI);
  int res = run_simple_test(NULL, "GET", url, NULL, NULL, NULL, NULL, 302, NULL, NULL, "unauthorized_client");
  free(url);
	ck_assert_int_eq(res, 1);
}
...
{
  char * url = msprintf("%s/auth?response_type=code&client_id=client1_id&redirect_uri=../static/index.html?param=client1_cb1&state=xyzabcd&scope=scope4", SERVER_URI);
...
{
  char * url = msprintf("%s/auth?response_type=code&client_id=client1_id&redirect_uri=../static/index.html?param=client1_cb1&state=xyzabcd", SERVER_URI);
  int res = run_simple_test(&user_req, "GET", url, NULL, NULL, NULL, NULL, 302, NULL, NULL, "invalid_scope");
  free(url);
	ck_assert_int_eq(res, 1);
}
...
{
  char * url = msprintf("%s/auth?response_type=code&client_id=client1_id&redirect_uri=../static/index.html?param=client1_cb1&state=xyzabcd&scope=scope1 scope2", SERVER_URI);
