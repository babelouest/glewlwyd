...
CREATE TABLE `gpg_refresh_token_scope` (
  `gpgrts_id` INT(11) PRIMARY KEY AUTO_INCREMENT,
  `gpgr_id` INT(11),
  `gpgrts_scope` VARCHAR(128) NOT NULL,
...
CREATE TABLE `gpg_access_token` (
  ...
  `gpga_username` VARCHAR(256) NOT NULL,
...
CREATE TABLE `gpg_access_token_scope` (
  `gpgats_id` INT(11) PRIMARY KEY AUTO_INCREMENT,
  `gpga_id` INT(11),
  `gpgats_scope` VARCHAR(128) NOT NULL,
